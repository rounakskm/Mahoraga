...
| In-sandbox harness | **NousResearch Hermes Agent** (migrated from OpenClaw 2026-06-12) | NVIDIA-documented Hermes-in-NemoClaw path; self-evolving skills (auto-written `SKILL.md`) we'd otherwise hand-build. Substrate-layer swap only — OpenShell sandbox + Hindsight + domain code unchanged. Reverses the 2026-05 "stay with OpenClaw" call. See [`docs/superpowers/specs/2026-06-12-hermes-runtime-migration.md`](docs/superpowers/specs/2026-06-12-hermes-runtime-migration.md). |
